...
2026-05-18 확인 기준 npm `latest`는 **`vibemud@0.1.27` multi-platform release**입니다. `0.1.27`은 native binary 실행 권한 보정까지 포함한 공개 권장 버전입니다. multi-platform release는 matching `@vibemud/native-*` optional package가 먼저 publish된 뒤 root package를 publish합니다.
