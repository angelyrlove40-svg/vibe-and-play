...
지원 표기는 실제 smoke 결과 기준입니다. **2026-05-13 현재 side-pane/HUD 자동화 검증 완료 대상은 tmux, cmux, macOS Ghostty뿐입니다. Codex와 iTerm2는 동작 실패가 확인되어 현재 미지원입니다.**
...
| macOS Apple Silicon npm/npx | ✅ preview | `vibemud@0.1.25`, `darwin/arm64` host-only preview |
...
- **npm preview package**: macOS Apple Silicon 사용자를 위한 간단 설치 경로
